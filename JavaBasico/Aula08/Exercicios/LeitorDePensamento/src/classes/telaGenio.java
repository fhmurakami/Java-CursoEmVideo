...
public class telaGenio extends javax.swing.JFrame {
    ...
    public telaGenio() { // CONSTRUTOR
        initComponents();
        // <html> </html> irá quebrar a linha automaticamente.
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 220, -1, -1));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        String f2 = "<html><pre>ERROU!</pre> Eu pensei no valor " + valor + ".</html>";
        
        String res = (valor == num) ? f1 : f2;
        
        // Altera a fonte e o tamanho
        lblFrase.setFont(new Font("DialogInput", Font.PLAIN, 16));
